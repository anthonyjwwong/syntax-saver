...
export default function NewSnippetPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto p-6 max-w">
      <button className="mb-3">
        <Link href="/dashboard" className="flex text-[14px] text-blue-500">
          {" "}
          <ArrowLeft size={16} className="mt-1" /> Back to Dashboard
        </Link>
      </button>
      <h1 className="text-xl font-bold lg:text-3xl">Create New Snippet</h1>
      <p className="text-[12px] text-gray-400 mt-2 lg:text-[16px]">
        Add a new code snippet to your collection
      </p>
      <div className="border p-5 mt-5 bg-white rounded-xl border-gray-300">
